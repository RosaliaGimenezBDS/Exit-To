...
Al iniciar este reto nos planteamos una serie de preguntas:

\begin{itemize}
\item \bf ¿Quienes son los más felices? Los empleados, los autónomos o los que trabajan en un negocio
...
\item \bf ¿Qué nivel de felicidad reportan las personas que han elegido un modelo determinado de relación
laboral?
