...
Este documento fue creado por paste(author) en la fecha print(format(Sys.Date(), "%d/%m/%Y")


*Observaciones* ´{ widht=400}
-----------------------------------------------------------------------

_Resumen de Datos_

El número total de observaciones inicial en el conjunto de datos es de print(nrow(datos)), pero para este panel lo hemos reducido a
print(nrow(datos_tabla_region_categoricos)) para una mayor agilidad en la ejecución del panel. En el caso de los gráficos, mantenemos un número de print(nrow(datos_tabla)) para permitir la observación de una evolución de las variables.


#Abrir el fichero README

Si lo deseas puedes acceder al fichero README

También puedes generar unas fichas en las que seleccionar año y territorio teniendo como resultado los niveles de felicidad, salud y seguridad.

```{r}

actionButton("showReadme", "Abrir README")

observeEvent(input$showReadme, {
    showModal(modalDialog(
      title = "Contenido del README",
      includeMarkdown("01_README.md"),
      easyClose = TRUE,
      footer = NULL
    ))
  })
